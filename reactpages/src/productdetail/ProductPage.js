...
import {getWineInfo} from '../data/winedata'
...
class ProductDetail extends React.Component {
    ...
    render() {
        ...
        let product = getWineInfo(product_id);
                        ...
                        <div className="container mt-5">
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <img id="wine_image" src={imgSrc} alt="img" className="img-fluid" width="130"
                                         height="350"/>
                                </div>
                                <div className="col-md-6">
                                    ...
                                    <ul className="list-group mb-4">
                                        ...
                                        <li className="list-group-item">Country: <span
                                            id="wine_country">{country}</span></li>
